...
class Category
{
     ...
     * Add jobs
     *
     * @param \Ens\JulesBundle\Entity\Job $jobs
     * @return Category
     */
    public function addJob(\Ens\JulesBundle\Entity\Job $jobs)
    {
        $this->jobs[] = $jobs;
     ...
     * @param \Ens\JulesBundle\Entity\Job $jobs
     */
    public function removeJob(\Ens\JulesBundle\Entity\Job $jobs)
    {
     ...
     *
     * @param \Ens\JulesBundle\Entity\CategoryAffiliate $categoryAffiliates
     * @return Category
     */
