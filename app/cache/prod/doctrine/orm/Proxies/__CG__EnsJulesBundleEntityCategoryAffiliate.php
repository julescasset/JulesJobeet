 ...
 */
class CategoryAffiliate extends \Ens\JulesBundle\Entity\CategoryAffiliate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ens\\JulesBundle\\Entity\\CategoryAffiliate' . "\0" . 'id', '' . "\0" . 'Ens\\JulesBundle\\Entity\\CategoryAffiliate' . "\0" . 'category', '' . "\0" . 'Ens\\JulesBundle\\Entity\\CategoryAffiliate' . "\0" . 'affiliate');
        }
